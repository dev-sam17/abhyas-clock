...
export function OMRInterface({ preset }: { preset: TestPreset }) {
  ...
  const selectAnswer = (questionNumber: number, option: string) => {
    trackQuestionTime(questionNumber);
      ...
      prev.map((ans) =>
        ans.questionNumber === questionNumber
          ? {
              ...
              timeSpentSeconds: questionTimes.get(questionNumber) || 0,
            }
          : ans
      )
    );
            ...
            <div className="flex-1">
              <div className="h-2 rounded-full bg-muted overflow-hidden">
                <div
                  ...
                  style={{
                    width: `${(answeredCount / preset.totalQuestions) * 100}%`,
                  }}
                />
              </div>
            </div>
                      ...
                      <div className="flex flex-1 gap-2">
                        {["A", "B", "C", "D", "E"].map((option) => (
                          <button
                            ...
                            type="button"
                            onClick={() =>
                              selectAnswer(answer.questionNumber, option)
                            }
                            className={cn(
                    ...
                    <>
                      <div className="flex-1">
                        <Input
                          ...
                          onChange={(e) =>
                            setTextAnswer(answer.questionNumber, e.target.value)
                          }
        ...
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>
              ...
              {answeredCount} out of {preset.totalQuestions} questions.
              {unansweredCount > 0 && (
                <span className="block mt-2 text-destructive font-medium">
                  Warning: {unansweredCount} question
